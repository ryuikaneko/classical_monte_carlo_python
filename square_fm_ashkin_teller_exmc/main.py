...
def main():
    ...
    parser.add_argument("--K", type=float, default=1.0, help="Spin exchange interaction K (default=1.0)")
...
#    seed = args.seed
    ...
    np.savetxt("dat_2d_ashkin_teller_L{}".format(L)+"_ave_err", dat_ave_err, fmt="%+.10f",
